...
public class FileWriterDemo {
	public static void main(String[] args) {
		...
		try {
			writer = new BufferedWriter(new FileWriter(path,true)); //the true in inside the () indicates that appending happens, if it hadn't been there then over writing would have happened
